...
// Fetch
$stmt = $conn->prepare('SELECT slno, hospitalname, address, locality, about, services, careers_url FROM omrhospitalslist WHERE slno = ?');
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $upd = $conn->prepare('UPDATE omrhospitalslist SET about = ?, services = ?, careers_url = ? WHERE slno = ?');
