...
$sql = "SELECT slno, office_name, address, contact, landmark FROM omr_gov_offices";
if ($locality !== '') {
...
<head>
<?php
$page_title          = 'Government Offices in OMR, Chennai | MyOMR';
$page_description    = 'Find government offices along Old Mahabalipuram Road (OMR), Chennai. Get office names, addresses, contacts, and landmarks for public services.';
$canonical_url       = 'https://myomr.in/government-offices';
$og_title            = 'Government Offices in OMR, Chennai | MyOMR';
$og_description      = 'Find government offices along Old Mahabalipuram Road (OMR), Chennai. Get office names, addresses, contacts, and landmarks for public services.';
$og_image            = 'https://myomr.in/My-OMR-Idhu-Namma-OMR-Logo.jpg';
$og_url              = 'https://myomr.in/government-offices';
$twitter_title       = 'Government Offices in OMR, Chennai | MyOMR';
$twitter_description = 'Find government offices along Old Mahabalipuram Road (OMR), Chennai. Get office names, addresses, contacts, and landmarks for public services.';
$twitter_image       = 'https://myomr.in/My-OMR-Idhu-Namma-OMR-Logo.jpg';
$breadcrumbs = [
  ['https://myomr.in/', 'Home'],
  ['https://myomr.in/government-offices', 'Government Offices']
];
?>
...
<link rel="canonical" href="https://myomr.in/government-offices" />
