...
$sql = "SELECT slno, industry_name, address, contact, industry_type FROM omr_industries";
if ($locality !== '') {
...
<head>
<?php
$page_title          = 'Industries in OMR, Chennai | MyOMR';
$page_description    = 'Explore major industries along Old Mahabalipuram Road (OMR), Chennai. Find industry names, addresses, types, and contact details for business and networking.';
$canonical_url       = 'https://myomr.in/industries';
$og_title            = 'Industries in OMR, Chennai | MyOMR';
$og_description      = 'Explore major industries along Old Mahabalipuram Road (OMR), Chennai. Find industry names, addresses, types, and contact details for business and networking.';
$og_image            = 'https://myomr.in/My-OMR-Idhu-Namma-OMR-Logo.jpg';
$og_url              = 'https://myomr.in/industries';
$twitter_title       = 'Industries in OMR, Chennai | MyOMR';
$twitter_description = 'Explore major industries along Old Mahabalipuram Road (OMR), Chennai. Find industry names, addresses, types, and contact details for business and networking.';
$twitter_image       = 'https://myomr.in/My-OMR-Idhu-Namma-OMR-Logo.jpg';
?>
<?php $breadcrumbs = [
  ['https://myomr.in/','Home'],
  ['https://myomr.in/omr-listings/industries.php','Industries']
]; ?>
...
<link rel="canonical" href="https://myomr.in/industries" />
