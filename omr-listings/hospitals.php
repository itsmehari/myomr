...
$sql = "SELECT slno, hospitalname, address, contact, landmark FROM omrhospitalslist";
...
<head>
<?php
$page_title          = 'Hospitals in OMR, Chennai | MyOMR';
$page_description    = 'Find hospitals along Old Mahabalipuram Road (OMR), Chennai. Get hospital names, addresses, contacts, and landmarks for healthcare services.';
$canonical_url       = 'https://myomr.in/hospitals';
$og_title            = 'Hospitals in OMR, Chennai | MyOMR';
$og_description      = 'Find hospitals along Old Mahabalipuram Road (OMR), Chennai. Get hospital names, addresses, contacts, and landmarks for healthcare services.';
$og_image            = 'https://myomr.in/My-OMR-Idhu-Namma-OMR-Logo.jpg';
$og_url              = 'https://myomr.in/hospitals';
$twitter_title       = 'Hospitals in OMR, Chennai | MyOMR';
$twitter_description = 'Find hospitals along Old Mahabalipuram Road (OMR), Chennai. Get hospital names, addresses, contacts, and landmarks for healthcare services.';
$twitter_image       = 'https://myomr.in/My-OMR-Idhu-Namma-OMR-Logo.jpg';
?>
<?php $breadcrumbs = [
  ['https://myomr.in/','Home'],
  ['https://myomr.in/omr-listings/hospitals.php','Hospitals']
]; ?>
...
<link rel="canonical" href="https://myomr.in/hospitals" />
...
<div class="container maxw-1280">
  <h1 class="text-center text-primary-omr">OMR Hospitals List - in and around OMR neighbourhood</h1>
  <?php
