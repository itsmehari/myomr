...
<div class="container" style="margin-top:30px;">
  <div class="row">
   ...
   <!-- logo with tag -->
   <div class="content"><a href="https://www.facebook.com/myomrCommunity" class="fa" target="_blank"><img src="https://cdn3.iconfinder.com/data/icons/social-media-2169/24/social_media_social_media_logo_facebook-128.png" width="30px;"  alt="Facebook"></a>
                    ...
                    <div class="col-xl-6 col-lg-6 d-none d-lg-block text-right">
                        <div class="footer-menu">
                            <ul>
                                ...
                                <li><a href="info/website-privacy-policy-of-my-omr.php">Privacy</a></li>
