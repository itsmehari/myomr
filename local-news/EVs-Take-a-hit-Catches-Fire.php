...
<head>
<?php
$page_title          = 'Electric Vehicles Catch Fire Due to Scorching Heat - OMR Road News 2022 | MyOMR';
$page_description    = 'Most electric vehicles catching fire due to scorching summer heat in 2022 - OMR road community news and safety updates.';
$canonical_url       = 'https://myomr.in/local-news/EVs-Take-a-hit-Catches-Fire.php';
$og_title            = 'Electric Vehicles Catch Fire Due to Scorching Heat - OMR Road News 2022 | MyOMR';
$og_description      = 'Most electric vehicles catching fire due to scorching summer heat in 2022 - OMR road community news and safety updates.';
$og_image            = 'https://myomr.in/My-OMR-Logo.png';
$og_url              = 'https://myomr.in/local-news/EVs-Take-a-hit-Catches-Fire.php';
$twitter_title       = 'Electric Vehicles Catch Fire Due to Scorching Heat - OMR Road News 2022 | MyOMR';
$twitter_description = 'Most electric vehicles catching fire due to scorching summer heat in 2022 - OMR road community news and safety updates.';
...
<section class="news">
  ...
  <div><img src="../Ev-Accident-Incident.jpg" style="max-width: 720px;"></div alt="Ev Accident Incident">
