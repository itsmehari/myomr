...
<section id="elections-2026" class="elections-2026-homepage homepage-section" aria-labelledby="elections-2026-heading">
  <div class="el-inner">
    <div class="el-layout">
      ...
      <aside class="el-sidebar" aria-label="Election quick stats">
        <div class="el-stat-card">
          <div class="el-stat-value">3</div>
          <div class="el-stat-label">Key constituencies</div>
        </div>
        <div class="el-stat-card">
          <div class="el-stat-value">4+</div>
          <div class="el-stat-label">Essential voter tools</div>
        </div>
        <div class="el-stat-card">
          <div class="el-stat-value"><?php echo !$is_past_poll ? (int) $days_to_poll : 0; ?></div>
          <div class="el-stat-label"><?php echo !$is_past_poll ? 'Days left to poll' : 'Poll completed'; ?></div>
        </div>
      </aside>
    </div>
  </div>
