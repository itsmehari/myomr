...
/**
 * View Inquiries
 * Space owners can view and manage space inquiries
 */
...
<section class="hero-modern py-4">
    <div class="container">
        <div class="d-flex justify-content-between align-items-center text-white">
            <div>
                <h1 class="hero-modern-title mb-2">Space Inquiries</h1>
                <p class="hero-modern-subtitle mb-0">Manage inquiries from potential users</p>
            </div>
    ...
    <div class="container">
        ...
        <?php if (empty($inquiries)): ?>
            <div class="card-modern p-5 text-center">
                ...
                <p class="text-muted mb-4">When people express interest in your workspaces, their inquiries will appear here.</p>
                <a href="my-spaces.php" class="btn btn-primary">Back to My Workspaces</a>
            </div>
        <?php else: ?>
            <div class="row">
                        ...
                        <div class="inquiry-card">
                            <div class="d-flex align-items-start gap-3">
                                ...
                                <div class="flex-grow-1">
                                    <div class="d-flex justify-content-between align-items-start mb-2">
                                        <div>
                                            ...
                                            <p class="text-muted mb-1 small">
                                                <i class="fas fa-building me-1"></i><?php echo htmlspecialchars($inquiry['space_name']); ?>
                                    ...
                                    <?php if (!empty($inquiry['interested_space_type'])): ?>
                                        <p class="mb-1"><strong>Interested in:</strong> <?php echo htmlspecialchars($inquiry['interested_space_type']); ?></p>
                                    <?php endif; ?>
