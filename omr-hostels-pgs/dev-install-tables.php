<?php
/**
 * Install Hostels & PGs Database Tables
...
echo "<title>Install Hostels & PGs Tables</title>\n";
...
echo "<h1>🔧 Installing Hostels & PGs Database Tables</h1>";

// Read SQL file
$sql_file = __DIR__ . '/CREATE-HOSTELS-PGS-DATABASE.sql';
...
if ($error_count === 0) {
    ...
    echo "<a href='index.php'>Go to Hostels & PGs</a></p>";
} else {
