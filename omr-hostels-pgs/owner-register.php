<?php
/**
 * Property Owner Registration – MyOMR Hostels & PGs Portal
...
$redirect = isset($_GET['redirect']) ? $_GET['redirect'] : 'my-properties.php?registered=1';
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($full_name) || empty($email)) {
        ...
        $stmt = $conn->prepare("SELECT id FROM property_owners WHERE email = ? LIMIT 1");
        ...
        if ($stmt->num_rows === 1) {
            ...
            $stmt->close();
            $stmt = $conn->prepare("UPDATE property_owners SET full_name = ?, phone = ? WHERE email = ?");
...
<head>
    ...
    <title>Register as Property Owner - MyOMR Hostels & PGs</title>
...
<div class="hero-modern">
    <div class="text-center text-white">
        ...
        <h1 class="hero-modern-title">Register as a Property Owner</h1>
        <p class="hero-modern-subtitle">Create your profile to list hostels and PGs, manage inquiries</p>
    </div>
</div>
                ...
                <div class="card-modern">
                    <div class="p-4">
                        ...
                        <p class="mb-0 text-center text-muted">
                            ...
                            <br>
                            Or you can <a href="add-property.php" class="text-primary fw-semibold">add a property</a> directly and we'll create your profile.
                        </p>
                    </div>
                </div>
            </div>
