...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && ($_POST['action'] ?? '') === 'delete') {
  ...
  $id = (int)($_POST['id'] ?? 0);
  $del = $conn->prepare('DELETE FROM omrbankslist WHERE slno = ?');
  $del->bind_param('i', $id);
  $del->execute();
  $del->close();
...
$sql = 'SELECT slno, bankname, address, contact FROM omrbankslist';
...
<div class="d-flex justify-content-between align-items-center mt-3 mb-3">
      ...
      <div class="table-responsive bg-white p-3">
        <table class="table table-bordered table-hover">
          <thead class="table-dark"><tr><th>#</th><th>Name</th><th>Address</th><th>Contact</th><th>Actions</th></tr></thead>
          <tbody>
