...
$pageTitle = $pageTitle ?? $title ?? 'Manage Government Offices';
...
<form method="get" class="mb-3">
        <div class="input-group">
          ...
          <div class="input-group-append">
            ...
            <?php if ($search !== ''): ?><a href="government-offices-list.php" class="btn btn-secondary ms-2">Clear</a><?php endif; ?>
          </div>
        </div>
      </form>
              ...
              <?php while ($row = $res->fetch_assoc()): ?>
                <tr>
                  ...
                  <td>
                    ...
                    ?>
                    <a class="btn btn-sm btn-info" href="government-offices-edit.php?slno=<?php echo (int)$row['slno']; ?>">Edit</a>
