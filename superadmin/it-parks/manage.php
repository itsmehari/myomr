...
$pageTitle = 'Manage IT Parks';
$activeNav = '/superadmin/it-parks/manage.php';
include __DIR__ . '/../includes/admin-shell-open.php';
?>
<style> .maxw-1280 { max-width: 1280px; } </style>
<div class="maxw-1280">
    <?php if (!empty($_GET['ok'])): ?><div class="alert alert-success alert-dismissible fade show" role="alert">Saved.<button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button></div><?php endif; ?>
