...
<section class="ca-hero py-4" aria-labelledby="ca-loc-title">
  <div class="container">
    <p class="ca-hero__kicker"><a href="/omr-classified-ads/" class="text-white-50 text-decoration-none">Classified Ads</a> · Area</p>
    <h1 id="ca-loc-title" class="ca-hero__title mb-2"><?= htmlspecialchars($locality) ?></h1>
...
<section class="py-4">
  <div class="container">
    ...
    <div class="py-4">
      <div class="ca-empty">
        <div class="ca-empty__icon" aria-hidden="true"><i class="fas fa-map-marker-alt"></i></div>
        <h2>No listings for this area yet</h2>
        <p class="text-muted mb-4">Be the first in <?= htmlspecialchars($locality) ?>.</p>
