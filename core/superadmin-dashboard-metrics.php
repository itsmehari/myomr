...
function sa_dash_module_cards(array $stats): array
{
    return [
        ...
        [
            ...
            'href'  => '/superadmin/community-events/view-listings.php',
            'manage'=> '/superadmin/community-events/manage-events-omr.php',
        ],
        [
            'group' => 'Jobs',
            'key'   => 'jobs',
        ...
        [
            ...
            'href'  => '/superadmin/classified-ads/manage-listings-omr.php',
            'manage'=> '/superadmin/classified-ads/index.php',
        ],
        [
            'group' => 'Marketplace',
            'key'   => 'buy_sell',
            ...
            'pending' => 0,
            'href'  => '/superadmin/buy-sell/manage-listings-omr.php',
            'manage'=> '/superadmin/buy-sell/index.php',
        ],
        [
            'group' => 'Marketplace',
            'key'   => 'rent',
            ...
            'href'  => '/superadmin/rent-lease/manage-properties-omr.php',
            'manage'=> '/superadmin/rent-lease/index.php',
        ],
        [
            'group' => 'Spaces',
            'key'   => 'hostels',
            ...
            'href'  => '/superadmin/hostels/manage-properties.php',
            'manage'=> '/superadmin/hostels/index.php',
        ],
        [
            'group' => 'Spaces',
            'key'   => 'coworking',
            ...
            'href'  => '/superadmin/coworking/manage-spaces.php',
            'manage'=> '/superadmin/coworking/index.php',
        ],
        [
            'group' => 'Directory',
            'key'   => 'restaurants',
